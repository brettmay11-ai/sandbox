...
http.createServer=function(...args){
  ...
  server.once('listening',async()=>{
    try {
      ...
      for(const [path,data] of [['scores/json/CurrentSeason',2026],['scores/json/Schedules/2026',[game]],['stats/json/PlayerGameStatsByWeek/2026REG/1',players],['scores/json/TeamGameStats/2026REG/1',teams],['derived/json/PlayerSeasonStats/2026',players],['derived/json/TeamSeasonStats/2026',teams],['scores/json/Standings/2026REG',[{Team:'SF',Conference:'NFC',Division:'West',Wins:1,Losses:0,PointsFor:21,PointsAgainst:14}]]]){
