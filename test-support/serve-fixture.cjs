...
http.createServer=function(...args){
  ...
  server.once('listening',async()=>{
    try {
      ...
      for(const [path,data] of [['scores/json/CurrentSeason',2026],['scores/json/Schedules/2026',[game]],['stats/json/PlayerSeasonStats/2026REG',players],['scores/json/TeamSeasonStats/2026REG',teams],['scores/json/Standings/2026REG',[{Team:'SF',Conference:'NFC',Division:'West',Wins:1,Losses:0,PointsFor:21,PointsAgainst:14}]]]){
