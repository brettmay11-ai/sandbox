...
if(location.pathname.startsWith('/teacher'))for(const source of ['/teacher-navigation.js?v=4','/teacher-featured-game.js?v=3','/teacher-coach-settings.js?v=2','/teacher-analytics.js?v=3','/teacher-writing.js?v=2','/teacher-teks.js?v=2','/teacher-student-editor.js?v=2']){const script=document.createElement('script');script.src=source;document.body.appendChild(script)}
