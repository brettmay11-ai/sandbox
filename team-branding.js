...
if(location.pathname.startsWith('/teacher'))for(const source of ['teacher-featured-game.js','teacher-coach-settings.js','teacher-analytics.js','teacher-writing.js']){const script=document.createElement('script');script.src=source;document.body.appendChild(script)}
