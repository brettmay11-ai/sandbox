(() => {
  ...
  style.textContent = `
    ...
    .math-game-midfield-logo{position:absolute;left:50%;top:50%;z-index:4;width:64px;height:64px;display:grid;place-items:center;opacity:.78;transform:translate(-50%,-50%);filter:drop-shadow(0 3px 4px rgba(0,0,0,.72));transition:opacity .2s ease,filter .2s ease}.math-game-midfield-logo.is-loaded{opacity:.86}
